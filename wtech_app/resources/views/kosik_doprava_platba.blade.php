...
<body>
    ...
    <section class="container bg-light ">
        ...
        @endphp
        <form method="POST" action="{{ route('payement') }}">
            @csrf
            <h3 class="mt-4">Doručenie tovaru</h3>
            <div class="container border border-dark my-2">
                <div class="my-2">
                    <input type="checkbox" id="kurier" name="delivery_method" value="kurier" {{ Session::get('delivery_method') == 'kurier' ? 'checked' : '' }} />
                    <label for="kurier">Doručenie kurierom(+2€)</label>
                </div>
                <div class="my-2">
                    <input type="checkbox" id="osobny_odber" name="delivery_method" value="osobny_odber" {{ Session::get('delivery_method') == 'osobny_odber' ? 'checked' : '' }} />
            ...
            <div class="container border border-dark my-2">
                <div class="my-2">
                    <input type="checkbox" id="back_ucet" name="payment_method" value="back_ucet" {{ Session::get('payment_method') == 'back_ucet' ? 'checked' : '' }} data-bs-toggle="collapse" href="#collapse1" />
                ...
                <div class="my-2">
                    <input type="checkbox" id="dobierka" name="payment_method" value="dobierka" {{ Session::get('payment_method') == 'dobierka' ? 'checked' : '' }} />
                    <label for="dobierka">Dobierka(+1€)</label>
                </div>
                <div class="my-2">
                    <input type="checkbox" id="hotovost" name="payment_method" value="hotovost" {{ Session::get('payment_method') == 'hotovost' ? 'checked' : '' }} />
            ...
            <div class="container pb-3 mt-3">
                <div class="row">
                    ...
                    <div class="col-6">
                    <input type="submit" value="Pokračovať" class="btn btn-primary float-end">
                    </div>
                </div>
            </div>
        </form>
